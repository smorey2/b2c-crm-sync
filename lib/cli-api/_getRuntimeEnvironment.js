...
module.exports = commandOptions => {
    ...
    // Set sfTestLevel based on what's defined in the .env file
    if (process.env.hasOwnProperty('SF_TESTLEVEL')) {
        output.sfTestLevel = process.env.SF_TESTLEVEL;
    }

    // Set sfRunTests based on what's defined in the .env file
    if (process.env.hasOwnProperty('SF_RUNTESTSBASE')) {
        output.sfRunTestsBase = process.env.SF_RUNTESTSBASE;
    }
    if (process.env.hasOwnProperty('SF_RUNTESTSEXTRAS')) {
        output.sfRunTestsExtras = process.env.SF_RUNTESTSEXTRAS;
    }
    if (process.env.hasOwnProperty('SF_RUNTESTSPERSONACCOUNTS')) {
        output.sfRunTestsPersonAccounts = process.env.SF_RUNTESTSPERSONACCOUNTS;
    }
